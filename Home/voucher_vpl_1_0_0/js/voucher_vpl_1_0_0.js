...
const voucher_vpl_1_0_0Temp = (data) => {
        ...
        <div class="voucher_vpl_1_0_0__wrapper">
            <div class="container">
                ...
                ${data.vouchers.length > limit ? `<div class="voucher_vpl_1_0_0__viewMore"><button onclick="viewMore(${data.id})">Xem thêm </button></div>` : ''}
            </div>
        </div>`
}
...
const voucher_vpl_1_0_0More = (data) => {
    var vouchers = []
    let voucherItem = ''
    let limit = data.vouchers.length;
...
function viewMore(index) {
    let count = index - 1
    document.getElementsByClassName('voucher_vpl_1_0_0__viewMore')[count].style.display='none';
    document.getElementsByClassName('voucher_vpl_1_0_0__box')[count].innerHTML = '';
    document.getElementsByClassName('voucher_vpl_1_0_0__box')[count].insertAdjacentHTML('beforeend', voucher_vpl_1_0_0More(voucher_vpl_1_0_0Data[count]))
}